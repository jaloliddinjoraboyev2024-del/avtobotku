...
def test_nft_sale_message_matches_configured_phrase():
    import userbot

    assert userbot.is_nft_sale_message("BIO NFT SOTILADI, narxi 2 TON", ["nft sotiladi"])


def test_nft_sale_message_ignores_unrelated_text():
    import userbot

    assert not userbot.is_nft_sale_message("Bugun oddiy yangilik bor", ["nft sotiladi"])
